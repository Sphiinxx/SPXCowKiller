...
public enum Location {
    ...
    EAST_LUMBRIDGE(new RSArea(new RSTile[]{
    ...
    NORTH_LUMBRIDGE(new RSArea(new RSTile[]{
    ...
    RIVER_LUM(new RSArea(new RSTile[]{
    ...
    CRAFTING_GUILD(new RSArea(new RSTile[]{
    ...
    ARDOUGNE(new RSArea(new RSTile[]{
